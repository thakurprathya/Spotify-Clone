...
const DetailsHeader = ({ artistId, artistData, songData }) => {
    const artist = artistData?.artists[artistId]?.attributes;  //added for making songs playable on artists detail page
    return(
      ...
      <div className="absolute inset-0 flex items-center">
        ...
        <div className="ml-5">
          ...
          {!artistId && (
            <Link to={`/artists/${songData?.artists[0]?.adamid}`}><p className="text-base text-gray-400 mt-2">{songData?.subtitle}</p></Link>
